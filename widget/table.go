...
var (
	...
	_ fyne.DoubleTappable = (*Table)(nil)
...
type Table struct {
	...
	OnDoubleTapped func(id TableCellID)                             `json:"-"`
...
func (t *Table) TypedKey(event *fyne.KeyEvent) {
	...
	case fyne.KeySpace:
		...
		t.Select(t.currentHighlight, modifiers)
...
// IsRowSelected returns true if the given row index is currently selected.
