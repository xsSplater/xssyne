...
type Menu struct {
	...
	// RightAlign прижимает этот пункт (вместе со следующими за ним
	// пунктами того же выравнивания) к правому краю полосы меню.
	// Используется, чтобы визуально отделить «системные» пункты
	// (аккаунт, профили, уведомления) от основных. Сепараторы
	// наследуют выравнивание от следующего не-сепараторного пункта,
	// поэтому разделитель между левой и правой группами оказывается
	// на стыке и визуально разделяет зоны.
	//
	// Since: xssyne
	RightAlign bool
}
